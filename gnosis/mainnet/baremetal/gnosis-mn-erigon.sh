...
cd ~
curl -LO https://github.com/ledgerwatch/erigon/releases/download/v${ERI_VER}/erigon_${ERI_VER}_linux_amd64.tar.gz
tar xvf erigon_${ERI_VER}_linux_amd64.tar.gz
sudo mv erigon /usr/local/bin
rm erigon_${ERI_VER}_linux_amd64.tar.gz
rm README.md
